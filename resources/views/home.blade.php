...
@section('content')
    <section class="section dashboard">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" class="text-primary">Sunt similique
                                                    distinctio</a></td>
                                            <td>$165</td>
                                            <td><span class="badge bg-success">Approved</span><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal">
                                                Basic Modal
                                              </button></td>
                                        </tr>
                                    </tbody>
        ...
        <div class="modal fade new-supplier" id="basicModal" tabindex="-1">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <span id="saveSupplier"  class="btn btn-primary">Save</span> 
                </div>
              </div>
            </div>
          </div>
...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    <script>//this script use to add supplier and load him on select option
        $('#saveSupplier').click(function(){
             $('.new-supplier').modal('hide');           
        })
    </script>
@endpush
